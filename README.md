...
The test scRNA-seq v3 data can be downloaded from [10X GENOMICS](https://www.10xgenomics.com/datasets?sort=publishedAt+DESC). Then prepare the `scMOCHA.inputs.json` file and follow the [Run scMOCHA](#3-run-scmocha) section to run the pipeline.
